                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title mb-2"><i class="mdi mdi-inbox mr-2"></i>Inbox</h4>  
                            <div class="">
                                <ol class="breadcrumb">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-5">
                                            <div class="btn-group float-right">
                                                <button type="button" class="btn btn-sm btn-primary waves-effect mb-0"><i class="fa fa-chevron-left"></i></button>
                                                <button type="button" class="btn btn-sm btn-primary waves-effect mb-0"><i class="fa fa-chevron-right"></i></button>
                                            </div>
                                        </div><!-- end Col -->
                                    </div> <!--end row-->   
